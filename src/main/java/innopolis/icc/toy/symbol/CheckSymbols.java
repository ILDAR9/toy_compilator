...
public class CheckSymbols {
    public static Symbol.Type getType(int tokenType) {
        switch ( tokenType ) {
            case TOY_parserParser.VOID :  return Symbol.Type.tVOID;
            case TOY_parserParser.INT :   return Symbol.Type.tINT;
            case TOY_parserParser.REAL : return Symbol.Type.tFLOAT;
            case TOY_parserParser.BOOLEAN : return Symbol.Type.tBoolean;
        }
